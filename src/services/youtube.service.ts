...
export async function getYoutubeVideoDetails(videoId: string): Promise<YouTubeApiResponse> {
...
export function convertYoutubeVideoDetails(details: YouTubeApiResponse) {
